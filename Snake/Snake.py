...
while True:
    ...
    for event in pygame.event.get():
        ...
        if event.type == KEYDOWN:
            #Move left
            if event.key == K_a and direction[0] != 1:
                direction = [-1, 0]
            #Move right
            if event.key == K_d and direction[0] != -1:
                direction = [1, 0]
            #Move up
            if event.key == K_w and direction[1] != 1:
                direction = [0, -1]
            #Move down
            if event.key == K_s and direction[1] != -1:
                direction = [0, 1]
